...
This visualization was provided by [Information is Beautiful](https://informationisbeautiful.net/visualizations/what-is-the-worlds-biggest-cash-crop/) with data pulled from sources including the United Nations, FAO, and UNODC. The [dataset](https://www.kaggle.com/code/valchovalev/agriculture-the-world-s-most-valuable-cash-crop) I used was different than the one provided by Makeover Monday. Instead, I used data provided by the article itself.

This visualization represents the most planted, most fecund, most popular, and most revenue making crops across all continents over 2014. This was one of the most interesting visualizations for me because I appreciated the aesthetics and the content presented. Although crops are initially not the most intriguing topic, after looking at the data, I thought it was really neat how they were able to show which crops brought in the most revenue in comparison to how much it was grown. The immediate surprise caught my attention, and I wanted to look into other ways to represent data and show what the world' biggest cash crop would be. 
...
#### Feedback
The feedback for this first sketch revolved mostly around there being too much presented. The student mentioned how there were too many lines to follow between them, and some of the coloring was too similar to differentiate. However, they did appreciate that there was a progression over time while the original did not have that context. The adult talked mostly about the grouping of crops and how there were too many. To eliminate confusion, they suggested creating even more condensed groups and getting rid of the ones that are not as influential. Overall, they both seemed to like this one but were overwhelmed with how much was going on in the visualization. Going forward, I need to look into other colors that audiences are able to differentiate that still revolve around earth tones. Since 8 is a lot of groups to follow for this type of graph, I might want to look into other ways to group the 21 crops. 
...
# Step Five
<div class='tableauPlaceholder' id='viz1707269851009' style='position: relative'><noscript><a href='#'><img alt='Dashboard 1 (3) ' src='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;Wh&#47;Whatistheworldsbiggestcashcropredesigntake2&#47;Dashboard13&#47;1_rss.png' style='border: none' /></a></noscript><object class='tableauViz'  style='display:none;'><param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' /> <param name='embed_code_version' value='3' /> <param name='site_root' value='' /><param name='name' value='Whatistheworldsbiggestcashcropredesigntake2&#47;Dashboard13' /><param name='tabs' value='no' /><param name='toolbar' value='yes' /><param name='static_image' value='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;Wh&#47;Whatistheworldsbiggestcashcropredesigntake2&#47;Dashboard13&#47;1.png' /> <param name='animate_transition' value='yes' /><param name='display_static_image' value='yes' /><param name='display_spinner' value='yes' /><param name='display_overlay' value='yes' /><param name='display_count' value='yes' /><param name='language' value='en-US' /><param name='filter' value='publish=yes' /></object></div>
<script type='text/javascript'>
  var divElement = document.getElementById('viz1707269851009');
...
Source: Information is Beautiful: What is the world's biggest cash crop?
Data Source: [bit.ly/KIB_CashCrops](https://www.kaggle.com/code/valchovalev/agriculture-the-world-s-most-valuable-cash-crop) 

### Recreation 
Using what I had learned from the critique, I created a dashboard with several treemaps show above. During the last stage of this assignment, I realized that the Makeover Monday dataset was not the same as the data used in the visualization. However, I did find the correct dataset and applied my sketches to it. This new dataset did not include data from different continents or over the last 40 years, so I had to change my final visualization from what I originally drew out. 

I changed the title to "Which crops are the most valuable?" instead of "What is the world's biggest cash crop?" because I could not provide world data to support that title. Additionally, I added a short subtitle that explains the biggest takeaway from these three visualizations. To provide a little more background on this data, I included the year in the subtitle as well. The colors selected were chosen because they matched earthy tones which was something that I appreciated from the original visualization. I stayed away from any bright colors that might pull the attention from the bigger squares in the treemap. Because of the toned down colors, people are able to focus their attention on the size of the rectangles instead. I ultimately decided on the treemap as it was the easiest for my two critics to understand. I appreciate that it includes all the crop groupings but highlighting the most important crops with the biggest squares. In the original visualization, there were a lot of crops that did not have as much significance in the story. Based on suggestion, I created 8 crop groupings based on the type of crop. For example, cereals included crops like wheat, barley, maize and rice. This is much less overwhelming for the audience compared to 21 crops. Although the original visualization had four bar charts, I decided to only include three. Most harvested shows in square kilometers how much each crop group is harvested while the most revenue shows which groups created the most revenue. The new visualuzation is how valuable a crop is in terms of the revenue per square kilometer harvested. I included the previous two charts as context to this final chart which addresses the title question. 

Looking at my redesign compared to the original design, it is hard to determine whether this is better. In some ways, I appreciate the original with how they were able to lead the audience to answer which crop creates the most revenue. However, I do like how my chart makes it more obvious which crop grouping is most valuable in size. People are able to understand the scale of how much more valuable it is compared to others. Additionally, I was able to provide more context by including a subtitle and year for the data. This way, the main idea of the visualization is obvious for the audience. 
